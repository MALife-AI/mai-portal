...
async def invoke_agent_stream(
    ...
    system_prompt = (
        ...
        "## 유사 상품 구분 규칙\n"
        "- 참고 출처에 이름이 비슷한 상품/특약이 여러 개 있을 수 있습니다 (예: 1-5종수술특약 vs 1-7종수술특약).\n"
        "- 숫자·종류·급여/비급여·간편고지 여부 등 정확한 상품명을 구분하세요.\n"
        "- 사용자가 특정 상품을 지목했으면 해당 출처만 인용하고, 다른 유사 상품의 내용을 섞지 마세요.\n"
        "- 사용자 질문이 모호하고 유사 상품이 2개 이상이면, 각 상품의 차이를 간단히 설명한 뒤 답변하세요.\n\n"
        "## 인용 규칙\n"
